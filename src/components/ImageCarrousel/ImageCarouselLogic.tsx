...
export default function ImageCarouselLogic(props: { images: string[] }) {
	...
	const handlePrevious = () => {
		...
		setActiveDotIndex((prevIndex: number) => (prevIndex === 0 ? images.length - 1 : prevIndex - 1));
	};
	...
	return { currentImageIndex, activeDotIndex, handlePrevious, handleNext, handleDotClick };
}
